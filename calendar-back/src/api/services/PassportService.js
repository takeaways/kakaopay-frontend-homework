...
let logger = CalendarServer.logger('PassportService');
...
function loadStrategies() {
  let self = this;
  let strategies = CalendarServer.config.passport;
  ...
  Object.keys(strategies).forEach(function (key) {
    ...
    if (key === 'local') {
      ...
      let baseUrl = CalendarServer.config.connections.oauthBaseUrl;
